...
export default function Home() {
  ...
  const s = {
    ...
    page: { paddingTop:64, minHeight:"100vh", display:"flex", flexDirection:"column" },
    header: { background:"#0C1A2E", padding:"3rem 2.5rem 2.5rem", position:"relative", overflow:"hidden" },
    headerInner: { maxWidth:1400, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"4rem", alignItems:"center" },
    tag: { display:"inline-flex", alignItems:"center", gap:8, fontSize:10, fontWeight:500, letterSpacing:"0.14em", textTransform:"uppercase", color:"#C9A84C", marginBottom:"1.25rem" },
    tagline: { display:"block", width:24, height:1, background:"#C9A84C" },
    title: { fontFamily:"'Cormorant Garamond',serif", fontSize:"clamp(2.5rem,4vw,4rem)", fontWeight:500, lineHeight:1.05, color:"white", letterSpacing:"-0.01em", marginBottom:"1.25rem" },
    titleEm: { fontStyle:"italic", color:"#C9A84C" },
    body: { fontSize:15, lineHeight:1.75, color:"rgba(255,255,255,0.65)", maxWidth:440, marginBottom:"1.75rem" },
    notice: { display:"flex", gap:12, padding:"14px 18px", background:"rgba(255,255,255,0.06)", border:"1px solid rgba(201,168,76,0.3)", borderLeft:"3px solid #C9A84C", borderRadius:6, fontSize:13, color:"rgba(255,255,255,0.6)", lineHeight:1.6, maxWidth:460 },
    nmark: { fontFamily:"'Cormorant Garamond',serif", fontSize:18, color:"#C9A84C", flexShrink:0, lineHeight:1.2, fontWeight:600 },
    scg: { display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 },
    scs: { background:"rgba(255,255,255,0.05)", border:"1px solid rgba(255,255,255,0.08)", borderRadius:10, padding:"14px 16px" },
    scv: { fontFamily:"'Cormorant Garamond',serif", fontSize:"1.9rem", fontWeight:500, color:"#E0C068", lineHeight:1, marginBottom:4 },
    scl: { fontSize:11, color:"rgba(255,255,255,0.4)", letterSpacing:"0.04em" },
    main: { flex:1, maxWidth:1400, margin:"0 auto", width:"100%", padding:"2rem 2.5rem 4rem", display:"grid", gridTemplateColumns:"1fr 300px", gap:"1.5rem", alignItems:"start" },
    ...
    msgs: { padding:"1.5rem", minHeight:520, maxHeight:600, overflowY:"auto", display:"flex", flexDirection:"column", gap:18 },
        ...
        <div style={s.header}>
          <div style={s.headerInner}>
            <div>
              ...
              <h1 style={s.title}>Help build an<br/><em style={s.titleEm}>intelligence</em><br/>from scratch</h1>
              <p style={s.body}>Young&apos;s Multimedia Holdings is training ARIA — a proprietary AI that will serve our entire portfolio. Every conversation you have here will be used to train her.</p>
              <div style={s.notice}>
